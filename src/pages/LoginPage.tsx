...
export default function LoginPage() {
  ...
  const handleForgotPasswordSubmit = async (
    ...
    try {
      setIsSubmitting(true);
      toast.info(
        "Forgot password flow is routed and ready for its API integration.",
      );
    } finally {
      setIsSubmitting(false);
    }
      ...
      <div className="mx-auto flex min-h-[calc(100vh-4rem)] max-w-3xl items-center justify-center">
        <div className="w-full max-w-127.5">
          ...
          >
            ...
            {!isForgotPasswordMode ? (
              <div
                className={`${isChangePasswordMode ? "mb-5" : "mb-10"} flex overflow-hidden rounded-xl border border-slate-300 bg-white`}
              >
                <input
                  id="password"
